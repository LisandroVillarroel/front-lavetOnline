...
@Component({
  selector: 'app-agregaEstructuraFormato1',
...
export class AgregaEstructuraFormato1Component implements OnInit {
  ...
  readonly dialogRef = inject(MatDialogRef<AgregaEstructuraFormato1Component>);
  ...
  async enviar() {
    ...
    console.log('pppp:', {
      ...
      descripcion: this.ingresaFormato1().get('descripcion')!.value,
      unidadMedida: this.ingresaFormato1().get('unidadMedida')!.value,
      resultado: '',
    ...
    this.examenEstructura.resultado.push({
      ordenEstructura: this.ingresaFormato1().get('ordenEstructura')!.value,
      descripcion: this.ingresaFormato1().get('descripcion')!.value,
      unidadMedida: this.ingresaFormato1().get('unidadMedida')!.value,
      resultado: '',

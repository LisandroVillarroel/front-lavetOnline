...
@Component({
  selector: 'app-formato7',
  templateUrl: './formato7.component.html',
  styleUrls: ['./formato7.component.scss'],
  imports: [MATERIAL_MODELO],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Formato7Component {
  readonly dialogRef = inject(MatDialogRef<Formato7Component>);
